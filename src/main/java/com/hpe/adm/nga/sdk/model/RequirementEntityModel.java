...
/**
 * <p>Entity Name: requirement</p>
 * <p>Label: Requirement</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "requirements", availableMethods = {EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class RequirementEntityModel extends TypedEntityModel implements RequirementEntity {

    public RequirementEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "requirement"));
    }

    public RequirementEntityModel(final EntityModel wrappedEntityModel) {
	...
	*/
        @AllowedReferences({RequirementDocumentEntityModel.class, RequirementRootEntityModel.class, RequirementFolderEntityModel.class, })
public <T extends RequirementEntity> T getParent(){
	...
	final String referenceType = type.getValue();
			...
			}else if (referenceType.equals("requirement_root")) {
			    return (T) new RequirementRootEntityModel(referenceFieldModel);
        ...
        public RequirementEntityModel setParent(final RequirementFolderEntityModel parent){
			if (parent == null) {
        ...
        @FieldMetadata(filterable = true, sortable = true, required = true)
        public RequirementEntityModel setParent(final RequirementRootEntityModel parent){
			if (parent == null) {
			    wrappedEntityModel.removeValue("parent");
			} else {
                wrappedEntityModel.setValue(new ReferenceFieldModel("parent", parent.getWrappedEntityModel()));
        ...
        @FieldMetadata(filterable = true, sortable = true, required = true)
        public RequirementEntityModel setParent(final RequirementDocumentEntityModel parent){
			if (parent == null) {
			    wrappedEntityModel.removeValue("parent");
			} else {
                wrappedEntityModel.setValue(new ReferenceFieldModel("parent", parent.getWrappedEntityModel()));
...
<EntityModel> value = release.getValue();
    	...
    	public RequirementEntityModel setRelease(final java.util.Collection<ReleaseEntityModel> release){
	    if (release == null) {
...
<EntityModel> value = features.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({QualityStoryEntityModel.class, EpicEntityModel.class, StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public RequirementEntityModel setFeatures(final java.util.Collection<WorkItemEntity> features){
	    if (features == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = phase.getValue();
            return new PhaseEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = true)
        public RequirementEntityModel setPhase(final PhaseEntityModel phase){
			if (phase == null) {
	...
	*/
	...
	public RequirementEntityModel setClientLockStamp(final Long clientLockStamp){
...
<EntityModel> value = test.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({TestManualEntityModel.class, TestSuiteEntityModel.class, GherkinTestEntityModel.class, TestAutomatedEntityModel.class, })
	public RequirementEntityModel setTest(final java.util.Collection<TestEntity> test){
	    if (test == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
        ...
        public RequirementEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
...
<EntityModel> value = related_from_requirements.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public RequirementEntityModel setRelatedFromRequirements(final java.util.Collection<RequirementDocumentEntityModel> relatedFromRequirements){
...
<EntityModel> value = user_tags.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public RequirementEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
...
<EntityModel> value = related_to_requirement.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public RequirementEntityModel setRelatedToRequirement(final java.util.Collection<RequirementDocumentEntityModel> relatedToRequirement){
	...
	*/
	...
	public RequirementEntityModel setName(final String name){
        if (name == null) {
...
<EntityModel> value = attachments.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public RequirementEntityModel setAttachments(final java.util.Collection<AttachmentEntityModel> attachments){
	    if (attachments == null) {
	...
	*/
    public String getOrdering(){
	    ...
	    return ordering == null ? null : (String) ordering.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public RequirementEntityModel setOrdering(final String ordering){
        if (ordering == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public RequirementEntityModel setDescription(final String description){
        if (description == null) {
	...
	*/
    public String getSubtype(){
	    ...
	    return subtype == null ? null : (String) subtype.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = true, maxLength = 255L)
	public RequirementEntityModel setSubtype(final String subtype){
        if (subtype == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = owner.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public RequirementEntityModel setOwner(final WorkspaceUserEntityModel owner){
			if (owner == null) {
