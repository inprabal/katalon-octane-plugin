...
/**
 * <p>Entity Name: test_suite</p>
 * <p>Label: Test Suite</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "test_suites", availableMethods = {EntityMetadata.AvailableMethods.DELETE, EntityMetadata.AvailableMethods.CREATE, EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class TestSuiteEntityModel extends TypedEntityModel implements TestSuiteEntity {

    public TestSuiteEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "test_suite"));
    }

    public TestSuiteEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public TestSuiteEntityModel(    final String name) {
        this();
                    setName(name);
        }
...
<EntityModel> value = covered_content.getValue();
    ...
    @AllowedReferences({StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public TestSuiteEntityModel setCoveredContent(final java.util.Collection<WorkItemEntity> coveredContent){
...
<EntityModel> value = backlog_coverage.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public TestSuiteEntityModel setBacklogCoverage(final java.util.Collection<WorkItemEntity> backlogCoverage){
	...
	*/
        public java.util.Collection<RunSuiteEntityModel> getRun(){
...
<EntityModel> value = run.getValue();
                        return value.stream().map(RunSuiteEntityModel::new)
        .collect(java.util.stream.Collectors.toList());
            }
	...
	*/
	...
	final EntityModel referenceFieldModel = program.getValue();
        ...
        public TestSuiteEntityModel setProgram(final ProgramEntityModel program){
			if (program == null) {
	...
	*/
	...
	public TestSuiteEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public TestSuiteEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
...
<EntityModel> value = product_areas.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setProductAreas(final java.util.Collection<ProductAreaEntityModel> productAreas){
...
<EntityModel> value = application_modules.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setApplicationModules(final java.util.Collection<ApplicationModuleEntityModel> applicationModules){
	...
	* Description: Number of hours estimated to complete the run.
	*/
...
<EntityModel> value = user_tags.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
	...
	*/
	...
	public TestSuiteEntityModel setName(final String name){
        if (name == null) {
...
<EntityModel> value = attachments.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setAttachments(final java.util.Collection<AttachmentEntityModel> attachments){
	    if (attachments == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public TestSuiteEntityModel setDescription(final String description){
        if (description == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = owner.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public TestSuiteEntityModel setOwner(final WorkspaceUserEntityModel owner){
			if (owner == null) {
...
<EntityModel> value = quality_stories.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setQualityStories(final java.util.Collection<QualityStoryEntityModel> qualityStories){
	...
	*/
	...
	final EntityModel referenceFieldModel = designer.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public TestSuiteEntityModel setDesigner(final WorkspaceUserEntityModel designer){
			if (designer == null) {
...
<EntityModel> value = covered_requirement.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public TestSuiteEntityModel setCoveredRequirement(final java.util.Collection<RequirementDocumentEntityModel> coveredRequirement){
...
<EntityModel> value = test_type.getValue();
	return value.stream().map(com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType::getFromEntityModel)
	    .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
	public TestSuiteEntityModel setTestType(final java.util.Collection<com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType> test_type) {
        if (test_type == null) {
