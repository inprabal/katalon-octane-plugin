...
/**
 * <p>Entity Name: test_runner</p>
 * <p>Label: Test Runner</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "test_runners", availableMethods = {EntityMetadata.AvailableMethods.GET, } )
public class TestRunnerEntityModel extends TypedEntityModel implements TestRunnerEntity {

    public TestRunnerEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "test_runner"));
    }

    public TestRunnerEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public TestRunnerEntityModel(    final String name) {
        this();
                    setName(name);
        }
	...
	*/
	...
	public TestRunnerEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	public TestRunnerEntityModel setName(final String name){
        if (name == null) {
