...
/**
 * <p>Entity Name: requirement_folder</p>
 * <p>Label: Requirement Folder</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "requirement_folders", availableMethods = {EntityMetadata.AvailableMethods.DELETE, EntityMetadata.AvailableMethods.CREATE, EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class RequirementFolderEntityModel extends TypedEntityModel implements RequirementFolderEntity {

    public RequirementFolderEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "requirement_folder"));
    }

    public RequirementFolderEntityModel(final EntityModel wrappedEntityModel) {
	...
	*/
        @AllowedReferences({RequirementRootEntityModel.class, RequirementFolderEntityModel.class, })
public <T extends RequirementEntity> T getParent(){
	...
	final String referenceType = type.getValue();
        ...
        public RequirementFolderEntityModel setParent(final RequirementFolderEntityModel parent){
			if (parent == null) {
        ...
        @FieldMetadata(filterable = true, sortable = true, required = true)
        public RequirementFolderEntityModel setParent(final RequirementRootEntityModel parent){
			if (parent == null) {
			    wrappedEntityModel.removeValue("parent");
			} else {
                wrappedEntityModel.setValue(new ReferenceFieldModel("parent", parent.getWrappedEntityModel()));
...
<EntityModel> value = attachments.getValue();
    	...
    	public RequirementFolderEntityModel setAttachments(final java.util.Collection<AttachmentEntityModel> attachments){
	    if (attachments == null) {
	...
	*/
	...
	public RequirementFolderEntityModel setOrdering(final String ordering){
        if (ordering == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public RequirementFolderEntityModel setDescription(final String description){
        if (description == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = owner.getValue();
        ...
        public RequirementFolderEntityModel setOwner(final WorkspaceUserEntityModel owner){
			if (owner == null) {
	...
	*/
    public Long getClientLockStamp(){
	    ...
	    return client_lock_stamp == null ? null : (Long) client_lock_stamp.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public RequirementFolderEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public RequirementFolderEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
...
<EntityModel> value = user_tags.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public RequirementFolderEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
	...
	*/
	...
	public RequirementFolderEntityModel setName(final String name){
        if (name == null) {
