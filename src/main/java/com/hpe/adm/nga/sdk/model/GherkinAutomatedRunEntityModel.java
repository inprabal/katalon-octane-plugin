...
/**
 * <p>Entity Name: gherkin_automated_run</p>
 * <p>Label: Gherkin Automated Run</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "gherkin_automated_runs", availableMethods = {EntityMetadata.AvailableMethods.DELETE, EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class GherkinAutomatedRunEntityModel extends TypedEntityModel implements GherkinAutomatedRunEntity {

    public GherkinAutomatedRunEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "gherkin_automated_run"));
    }

    public GherkinAutomatedRunEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public GherkinAutomatedRunEntityModel(    final String name, final GherkinTestEntityModel test) {
        this();
                    setName(name);
            setTest(test);
        }
	...
	*/
	...
	final EntityModel referenceFieldModel = release.getValue();
        ...
        public GherkinAutomatedRunEntityModel setRelease(final ReleaseEntityModel release){
			if (release == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = sprint.getValue();
        ...
        public GherkinAutomatedRunEntityModel setSprint(final SprintEntityModel sprint){
			if (sprint == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = program.getValue();
            return new ProgramEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setProgram(final ProgramEntityModel program){
			if (program == null) {
...
<EntityModel> value = defect.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinAutomatedRunEntityModel setDefect(final java.util.Collection<DefectEntityModel> defect){
	    if (defect == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = test_version.getValue();
        ...
        public GherkinAutomatedRunEntityModel setTestVersion(final TestVersionEntityModel testVersion){
			if (testVersion == null) {
	...
	*/
	...
	public GherkinAutomatedRunEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	final EntityModel referenceFieldModel = test.getValue();
        ...
        public GherkinAutomatedRunEntityModel setTest(final GherkinTestEntityModel test){
			if (test == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = run_by.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setRunBy(final WorkspaceUserEntityModel runBy){
			if (runBy == null) {
...
<EntityModel> value = user_tags.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinAutomatedRunEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
...
<EntityModel> value = taxonomies.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinAutomatedRunEntityModel setTaxonomies(final java.util.Collection<TaxonomyItemNodeEntityModel> taxonomies){
	    if (taxonomies == null) {
	...
	*/
    public Boolean getDraftRun(){
	    ...
	    return draft_run == null ? null : (Boolean) draft_run.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public GherkinAutomatedRunEntityModel setDraftRun(final Boolean draftRun){
        if (draftRun == null) {
	...
	*/
	...
	public GherkinAutomatedRunEntityModel setName(final String name){
        if (name == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = on_it.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setOnIt(final WorkspaceUserEntityModel onIt){
			if (onIt == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public GherkinAutomatedRunEntityModel setDescription(final String description){
        if (description == null) {
...
<EntityModel> value = quality_stories.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinAutomatedRunEntityModel setQualityStories(final java.util.Collection<QualityStoryEntityModel> qualityStories){
	...
	*/
	...
	final EntityModel referenceFieldModel = last_modified_by.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = false, required = false)
        public GherkinAutomatedRunEntityModel setLastModifiedBy(final WorkspaceUserEntityModel lastModifiedBy){
...
<EntityModel> value = test_type.getValue();
	return value.stream().map(com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType::getFromEntityModel)
	    .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
	public GherkinAutomatedRunEntityModel setTestType(final java.util.Collection<com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType> test_type) {
        if (test_type == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = parent_suite.getValue();
            return new RunSuiteEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = false, required = false)
        public GherkinAutomatedRunEntityModel setParentSuite(final RunSuiteEntityModel parentSuite){
			if (parentSuite == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = merged_on_it.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setMergedOnIt(final WorkspaceUserEntityModel mergedOnIt){
			if (mergedOnIt == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = milestone.getValue();
            return new MilestoneEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinAutomatedRunEntityModel setMilestone(final MilestoneEntityModel milestone){
			if (milestone == null) {
