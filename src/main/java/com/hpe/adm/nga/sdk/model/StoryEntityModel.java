...
/**
 * <p>Entity Name: story</p>
 * <p>Label: Story</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "stories", availableMethods = {EntityMetadata.AvailableMethods.DELETE, EntityMetadata.AvailableMethods.CREATE, EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class StoryEntityModel extends TypedEntityModel implements StoryEntity {

    public StoryEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "story"));
    }

    public StoryEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public StoryEntityModel(    final String name, final FeatureEntityModel parent, final com.hpe.adm.nga.sdk.enums.Phases.StoryPhase phase) {
        this();
                    setName(name);
            setParent(parent);
            setPhase(phase);
        }
        public StoryEntityModel(    final String name, final WorkItemRootEntityModel parent, final com.hpe.adm.nga.sdk.enums.Phases.StoryPhase phase) {
        this();
                    setName(name);
            setParent(parent);
            setPhase(phase);
...
public <T extends WorkItemEntity> T getParent(){
	...
	final String referenceType = type.getValue();
        ...
        public StoryEntityModel setParent(final FeatureEntityModel parent){
			if (parent == null) {
        ...
        @FieldMetadata(filterable = true, sortable = true, required = true)
        public StoryEntityModel setParent(final WorkItemRootEntityModel parent){
			if (parent == null) {
			    wrappedEntityModel.removeValue("parent");
			} else {
                wrappedEntityModel.setValue(new ReferenceFieldModel("parent", parent.getWrappedEntityModel()));
	...
	*/
	...
	final EntityModel referenceFieldModel = release.getValue();
        ...
        public StoryEntityModel setRelease(final ReleaseEntityModel release){
			if (release == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = program.getValue();
            return new ProgramEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setProgram(final ProgramEntityModel program){
			if (program == null) {
	...
	*/
    public com.hpe.adm.nga.sdk.enums.Phases.StoryPhase getPhase() {
    ...
    return com.hpe.adm.nga.sdk.enums.Phases.StoryPhase.getFromEntityModel(referenceFieldModel);
}


            @FieldMetadata(filterable = true, sortable = true, required = true)
	public StoryEntityModel setPhase(final com.hpe.adm.nga.sdk.enums.Phases.StoryPhase phase) {
        if (phase == null) {
	...
	*/
    public Boolean getHasChildren(){
        ...
        /**
	* Label: Priority
	* Description: The priority of the user story, from 5 (Low) to 1 (Urgent).
	*/
    ...
    return com.hpe.adm.nga.sdk.enums.lists.list_node.priority.Priority.getFromEntityModel(referenceFieldModel);
                ...
                @FieldMetadata(filterable = true, sortable = true, required = false)
	public StoryEntityModel setPriority(final com.hpe.adm.nga.sdk.enums.lists.list_node.priority.Priority priority) {
    if (priority == null) {
...
<EntityModel> value = user_tags.getValue();
    	...
    	public StoryEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
...
<EntityModel> value = attachments.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public StoryEntityModel setAttachments(final java.util.Collection<AttachmentEntityModel> attachments){
	    if (attachments == null) {
	...
	*/
	...
	public StoryEntityModel setOrdering(final String ordering){
        if (ordering == null) {
	...
	*/
    public Boolean getBlocked(){
	    ...
	    return blocked == null ? null : (Boolean) blocked.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public StoryEntityModel setBlocked(final Boolean blocked){
        if (blocked == null) {
...
<EntityModel> value = dependence.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({QualityStoryEntityModel.class, StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public StoryEntityModel setDependence(final java.util.Collection<WorkItemEntity> dependence){
	    if (dependence == null) {
...
<EntityModel> value = linked_items2.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public StoryEntityModel setLinkedItems2(final java.util.Collection<WorkItemEntity> linkedItems2){
	...
	*/
    public Long getStoryPoints(){
	    ...
	    return story_points == null ? null : (Long) story_points.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public StoryEntityModel setStoryPoints(final Long storyPoints){
        if (storyPoints == null) {
    ...
    /**
	* Label: Story(Trace from)
	* Description: 
	*/
        @AllowedReferences({QualityStoryEntityModel.class, StoryEntityModel.class, })
...
<EntityModel> value = linked_items1.getValue();
            ...
            final StringFieldModel type = (StringFieldModel) entityModel.getValue("type");
            final String referenceType = type.getValue();
                            if (referenceType.equals("quality_story")) {
				    return new QualityStoryEntityModel(entityModel);
				}                else if (referenceType.equals("story")) {
				    return new StoryEntityModel(entityModel);
				}else {
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({QualityStoryEntityModel.class, StoryEntityModel.class, })
	public StoryEntityModel setLinkedItems1(final java.util.Collection<WorkItemEntity> linkedItems1){
	...
	*/
	...
	final EntityModel referenceFieldModel = team.getValue();
            return new TeamEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setTeam(final TeamEntityModel team){
			if (team == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = sprint.getValue();
            return new SprintEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setSprint(final SprintEntityModel sprint){
			if (sprint == null) {
	...
	*/
    public Long getClientLockStamp(){
	    ...
	    return client_lock_stamp == null ? null : (Long) client_lock_stamp.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public StoryEntityModel setClientLockStamp(final Long clientLockStamp){
...
<EntityModel> value = test.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({TestManualEntityModel.class, TestSuiteEntityModel.class, GherkinTestEntityModel.class, TestAutomatedEntityModel.class, })
	public StoryEntityModel setTest(final java.util.Collection<TestEntity> test){
	    if (test == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
...
<EntityModel> value = product_areas.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public StoryEntityModel setProductAreas(final java.util.Collection<ProductAreaEntityModel> productAreas){
...
<EntityModel> value = application_modules.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public StoryEntityModel setApplicationModules(final java.util.Collection<ApplicationModuleEntityModel> applicationModules){
	...
	*/
	...
	public StoryEntityModel setName(final String name){
        if (name == null) {
...
<EntityModel> value = commits.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public StoryEntityModel setCommits(final java.util.Collection<ScmCommitEntityModel> commits){
	    if (commits == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public StoryEntityModel setDescription(final String description){
        if (description == null) {
	...
	*/
    public java.time.ZonedDateTime getClosedOn(){
	    ...
	    return closed_on == null ? null : (java.time.ZonedDateTime) closed_on.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public StoryEntityModel setClosedOn(final java.time.ZonedDateTime closedOn){
        if (closedOn == null) {
	...
	*/
    public java.time.ZonedDateTime getDoneDate(){
	    ...
	    return done_date == null ? null : (java.time.ZonedDateTime) done_date.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public StoryEntityModel setDoneDate(final java.time.ZonedDateTime doneDate){
        if (doneDate == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = owner.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setOwner(final WorkspaceUserEntityModel owner){
			if (owner == null) {
...
<EntityModel> value = requirements.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public StoryEntityModel setRequirements(final java.util.Collection<RequirementDocumentEntityModel> requirements){
	    if (requirements == null) {
...
<EntityModel> value = depends_on.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({QualityStoryEntityModel.class, StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public StoryEntityModel setDependsOn(final java.util.Collection<WorkItemEntity> dependsOn){
	    if (dependsOn == null) {
...
<EntityModel> value = comments.getValue();
	...
	*/
	...
	final EntityModel referenceFieldModel = milestone.getValue();
            return new MilestoneEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public StoryEntityModel setMilestone(final MilestoneEntityModel milestone){
			if (milestone == null) {
	...
	*/
	...
	public StoryEntityModel setBlockedReason(final String blockedReason){
