...
/**
 * <p>Entity Name: uft_test_runner</p>
 * <p>Label: Uft Test Runner</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "uft_test_runners", availableMethods = {EntityMetadata.AvailableMethods.GET, } )
public class UftTestRunnerEntityModel extends TypedEntityModel implements UftTestRunnerEntity {

    public UftTestRunnerEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "uft_test_runner"));
    }

    public UftTestRunnerEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public UftTestRunnerEntityModel(    final String name) {
        this();
                    setName(name);
        }
	...
	*/
	...
	public UftTestRunnerEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	public UftTestRunnerEntityModel setName(final String name){
        if (name == null) {
