...
/**
 * <p>Entity Name: gherkin_test</p>
 * <p>Label: Gherkin Test</p>
 *
 * Generated class.  <b>Do not manually edit.</b>
 */
@EntityMetadata(url = "gherkin_tests", availableMethods = {EntityMetadata.AvailableMethods.DELETE, EntityMetadata.AvailableMethods.CREATE, EntityMetadata.AvailableMethods.GET, EntityMetadata.AvailableMethods.UPDATE, } )
public class GherkinTestEntityModel extends TypedEntityModel implements GherkinTestEntity {

    public GherkinTestEntityModel() {
        super();
        wrappedEntityModel.setValue(new StringFieldModel("type", "gherkin_test"));
    }

    public GherkinTestEntityModel(final EntityModel wrappedEntityModel) {
        super(wrappedEntityModel);
    }

            public GherkinTestEntityModel(    final String name, final com.hpe.adm.nga.sdk.enums.Phases.GherkinTestPhase phase) {
        this();
                    setName(name);
            setPhase(phase);
        }
	...
	* Description: 
	*/
        public TestRunnerEntityModel getTestRunner(){
	...
	final EntityModel referenceFieldModel = test_runner.getValue();
            return new TestRunnerEntityModel(referenceFieldModel);
    }

                        @FieldMetadata(filterable = true, sortable = false, required = false)
        public GherkinTestEntityModel setTestRunner(final TestRunnerEntityModel testRunner){
			if (testRunner == null) {
...
<EntityModel> value = covered_content.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public GherkinTestEntityModel setCoveredContent(final java.util.Collection<WorkItemEntity> coveredContent){
...
<EntityModel> value = backlog_coverage.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    @AllowedReferences({StoryEntityModel.class, FeatureEntityModel.class, DefectEntityModel.class, })
	public GherkinTestEntityModel setBacklogCoverage(final java.util.Collection<WorkItemEntity> backlogCoverage){
	...
	*/
        @AllowedReferences({GherkinAutomatedRunEntityModel.class, RunManualEntityModel.class, })
...
<EntityModel> value = run.getValue();
	...
	*/
	...
	final EntityModel referenceFieldModel = program.getValue();
        ...
        public GherkinTestEntityModel setProgram(final ProgramEntityModel program){
			if (program == null) {
	...
	*/
    public com.hpe.adm.nga.sdk.enums.Phases.GherkinTestPhase getPhase() {
    ...
    return com.hpe.adm.nga.sdk.enums.Phases.GherkinTestPhase.getFromEntityModel(referenceFieldModel);
}


            @FieldMetadata(filterable = true, sortable = true, required = true)
	public GherkinTestEntityModel setPhase(final com.hpe.adm.nga.sdk.enums.Phases.GherkinTestPhase phase) {
        if (phase == null) {
	...
	*/
	...
	public GherkinTestEntityModel setClientLockStamp(final Long clientLockStamp){
	...
	*/
	...
	final EntityModel referenceFieldModel = author.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinTestEntityModel setAuthor(final WorkspaceUserEntityModel author){
			if (author == null) {
...
<EntityModel> value = product_areas.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setProductAreas(final java.util.Collection<ProductAreaEntityModel> productAreas){
...
<EntityModel> value = application_modules.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setApplicationModules(final java.util.Collection<ApplicationModuleEntityModel> applicationModules){
	...
	*/
    public Long getEstimatedDuration(){
	    ...
	    return estimated_duration == null ? null : (Long) estimated_duration.getValue();
            ...
            @FieldMetadata(filterable = true, sortable = true, required = false)
	public GherkinTestEntityModel setEstimatedDuration(final Long estimatedDuration){
...
<EntityModel> value = user_tags.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setUserTags(final java.util.Collection<UserTagEntityModel> userTags){
	    if (userTags == null) {
	...
	*/
        public java.util.Collection<TestSuiteLinkToGherkinEntityModel> getLinkToTest(){
...
<EntityModel> value = link_to_test.getValue();
                        return value.stream().map(TestSuiteLinkToGherkinEntityModel::new)
        .collect(java.util.stream.Collectors.toList());
            }
	...
	*/
	...
	public GherkinTestEntityModel setName(final String name){
        if (name == null) {
	...
	*/
    ...
    return com.hpe.adm.nga.sdk.enums.lists.list_node.automation_status.AutomationStatus.getFromEntityModel(referenceFieldModel);
                ...
                @FieldMetadata(filterable = true, sortable = true, required = false)
	public GherkinTestEntityModel setAutomationStatus(final com.hpe.adm.nga.sdk.enums.lists.list_node.automation_status.AutomationStatus automation_status) {
...
<EntityModel> value = attachments.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setAttachments(final java.util.Collection<AttachmentEntityModel> attachments){
	    if (attachments == null) {
	...
	*/
    public String getDescription(){
	    ...
	    return description == null ? null : (String) description.getValue();
            ...
            @FieldMetadata(filterable = false, sortable = false, required = false)
	public GherkinTestEntityModel setDescription(final String description){
        if (description == null) {
	...
	*/
	...
	final EntityModel referenceFieldModel = owner.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinTestEntityModel setOwner(final WorkspaceUserEntityModel owner){
			if (owner == null) {
...
<EntityModel> value = quality_stories.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setQualityStories(final java.util.Collection<QualityStoryEntityModel> qualityStories){
	...
	*/
	...
	final EntityModel referenceFieldModel = designer.getValue();
            return new WorkspaceUserEntityModel(referenceFieldModel);
                        ...
                        @FieldMetadata(filterable = true, sortable = true, required = false)
        public GherkinTestEntityModel setDesigner(final WorkspaceUserEntityModel designer){
			if (designer == null) {
...
<EntityModel> value = covered_requirement.getValue();
        ...
        .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
    	public GherkinTestEntityModel setCoveredRequirement(final java.util.Collection<RequirementDocumentEntityModel> coveredRequirement){
...
<EntityModel> value = test_type.getValue();
	return value.stream().map(com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType::getFromEntityModel)
	    .collect(java.util.stream.Collectors.toList());
                ...
                @FieldMetadata(filterable = true, sortable = false, required = false)
	public GherkinTestEntityModel setTestType(final java.util.Collection<com.hpe.adm.nga.sdk.enums.lists.list_node.test_type.TestType> test_type) {
        if (test_type == null) {
