...
public class RestClient {
    ...
    public RestClient(Settings settings) {
        ...
        // proxy setting
		/*
		 * if (StringUtils.isNotEmpty(settings.getProxyHost())) { HttpHost proxy = new
		 * HttpHost(settings.getProxyHost(), settings.getProxyPort());
		 * requestConfigBuilder.setProxy(proxy); if (settings.getProxyUser() != null) {
		 * CredentialsProvider credentialsProvider = new BasicCredentialsProvider();
		 * credentialsProvider.setCredentials( new AuthScope(settings.getProxyHost(),
		 * settings.getProxyPort()), new
		 * UsernamePasswordCredentials(settings.getProxyUser(),
    ...
    public long postTestResult(HttpEntity entity) throws IOException, com.katalon.plugin.octane.exception.ValidationException {
...
//    }
    ...
    private void authenticate() throws IOException {
        ...
        String clientID = settings.getClientID() != null ? settings.getClientID() : "";
        String clientSecret = settings.getClientSecret() != null ? settings.getClientSecret() : "";
        String authorization = "{\"client_id\":\"" + clientID + "\",\"client_secret\":\"" + clientSecret + "\"}";
